...
with aba_pesquisa:
    if st.session_state.enviado:
        ...
        st.info("Agradecemos a sua participação! Sua percepção foi registrada de forma 100% anônima e segura. Você já pode fechar esta aba.")
        ...
        if cookie_status == "respondido":
            ...
            st.info("Obrigado! Seu dispositivo já computou as respostas para este ciclo.")
